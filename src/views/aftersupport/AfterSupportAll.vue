...
<script>
  import { AccountApis, AfterSupportApis } from '../../utils/api'
  ...
  export default {
    ...
    methods: {
      ...
      goAfterSupportDetail (id) {
        this.$router.push({ name: 'AfterSupportAllDetail', params: { id: id } })
      },
      // 跳转到客户详情信息页面
      goCustomerDetail (id) {
      ...
      getAfterSupportList () {
        this.loading = true
        axios.get(AfterSupportApis.afterSupportAllListUrl, {
          params: {
