<template>
  <!-- 后端人员创建客户 -->
  <div class="page-customer-create">
    <!-- 面包屑导航 -->
    ...
    <el-form :model="CustomerForm" :rules="rules" ref="CustomerForm" label-width="80px" style="width: 50%">
      <el-form-item label="客户名称" prop="name">
        <el-input v-model="CustomerForm.name" placeholder="请填写客户公司全称" clearable></el-input>
      </el-form-item>
      ...
      <el-form-item label="业务" prop="user">
        <el-select v-model="CustomerForm.user" placeholder="请选择业务人员" clearable>
          <el-option
    ...
    data () {
      return {
        ...
        rules: {
          ...
          user: [
            { required: true, message: '请选择所属业务人员', trigger: 'change' }
          ]
        }
      }
    },
